...
const saturationStep2 = 0.05; // Saturation step, dark part
const brightnessStep1 = 0.05; // Brightness step, light part
const brightnessStep2 = 0.15; // Brightness step, dark part
const lightColorCount = 5; // number of light colors, on the main color
const darkColorCount = 4; // Number of dark
